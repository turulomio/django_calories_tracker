...
def test_elaborations_experiences(self):     
    ...
    tests_helpers.client_post(self, self.client_authorized_1, "/api/elaborations_experiences/", models.ElaborationsExperiences.post_payload(elaborations=dict_elaborations["url"]), status.HTTP_201_CREATED)
